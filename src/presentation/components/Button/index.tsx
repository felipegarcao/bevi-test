...
export function Button({ loading, children, variant  = 'default', className, ...props }: ButtonProps) {
  ...
  return (
    <button data-testid={variant} className={`${className} btn p-2 d-flex align-items-center justify-content-center  gap-2 ${selectedVariant.className}`} {...props} disabled={loading}>
